...
def corregir_errores(texto):
    ...
    for palabra in palabras:
        ...
        palabra_corregida = ''.join([num_to_letter.get(char, char) for char in palabra])
        # Aplicar corrección ortográfica
        palabra_corregida = spell(palabra_corregida)
...
def index():
    ...
    return render_template('index2.html', texto=texto, texto_corregido=texto_corregido, mensaje_error=mensaje_error, habilidades=habilidades)
